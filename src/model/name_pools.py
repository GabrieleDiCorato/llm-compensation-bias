...
NAME_POOLS: dict[tuple[str, str], list[str]] = {
    ...
    ("White", "Male"): [
        ...
        "Matthew", "Christopher", "Daniel", "Andrew", "Brian"
    ],
    ("White", "Female"): [
        "Emily", "Sarah", "Jennifer", "Jessica", "Ashley",
        "Amanda", "Megan", "Lauren", "Rachel", "Allison"
    ],
    ("White", "Non-binary"): [
        "Alex", "Jordan", "Taylor", "Casey", "Morgan",
        "Riley", "Avery", "Quinn", "Cameron", "Drew"
    ],
    
    # Black/African American names - Distinctively Black names from research
    ("Black/African American", "Male"): [
        "Jamal", "DeShawn", "Tyrone", "Darnell", "Malik",
        "Terrell", "Kareem", "Jermaine", "Rashad", "Darius"
    ],
    ("Black/African American", "Female"): [
        "Lakisha", "Tanisha", "Ebony", "Latoya", "Kenya",
        "Shanice", "Tamika", "Imani", "Aaliyah", "Nia"
    ],
    ("Black/African American", "Non-binary"): [
        "Kendall", "Skylar", "Reese", "Jayden", "Dakota",
        "Phoenix", "Sage", "River", "Kai", "Monroe"
    ],
    
    # Hispanic/Latino names - Common Spanish first names
    ("Hispanic/Latino", "Male"): [
        "Jose", "Carlos", "Luis", "Miguel", "Juan",
        "Diego", "Antonio", "Fernando", "Jorge", "Rafael"
    ],
    ("Hispanic/Latino", "Female"): [
        "Maria", "Carmen", "Isabella", "Sofia", "Gabriela",
        "Lucia", "Rosa", "Camila", "Valentina", "Elena"
    ],
    ("Hispanic/Latino", "Non-binary"): [
        "Angel", "Adrian", "Alex", "Cruz", "Guadalupe",
        "Dakota", "River", "Sage", "Phoenix", "Sky"
    ],
    
    # Asian names - Mix of East Asian, South Asian, and Southeast Asian
    ("Asian", "Male"): [
        "Wei", "Ming", "Raj", "Arjun", "Kenji",
        "Hiroshi", "Dae", "Chen", "Kumar", "Nguyen"
    ],
    ("Asian", "Female"): [
        "Li", "Mei", "Priya", "Aisha", "Yuki",
        "Sakura", "Min", "Lin", "Anjali", "Linh"
    ],
    ("Asian", "Non-binary"): [
        "Jin", "Sasha", "Kai", "Yuki", "Ren",
        "Sai", "Aspen", "River", "Phoenix", "Sky"
    ],
}
